...
const CONTENT_TYPE_ROUTES: Record<string, string> = {
  ...
  aso_evaluate_app_store:  "/dashboard/aso",
  aso_evaluate_play_store: "/dashboard/aso",
...
const TYPE_LABELS: Record<string, { label: string; icon: string }> = {
  ...
  aso_evaluate_app_store:  { label: "App Store Audit",  icon: "🍎" },
  aso_evaluate_play_store: { label: "Play Store Audit", icon: "▶️" },
